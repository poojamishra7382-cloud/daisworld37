...
import { OilAndGasDepartment, oilAndGasDepartments } from '@/data/oilAndGasDepartments';

interface Props {
  department: OilAndGasDepartment;
}

export default function OilAndGasDepartmentDetailView({ department }: Props) {
  const [selectedRoleIndex, setSelectedRoleIndex] = useState(0);

  const activeRole = department.roles[selectedRoleIndex] || department.roles[0];
  const otherDepartments = oilAndGasDepartments.filter((d) => d.id !== department.id);
  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen">
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-2xl sm:text-4xl font-black text-slate-900 leading-tight mb-5">
                Offshore, Refinery & Energy Standards in{' '}
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-900 mb-1">
                      Offshore Rotation & Relocation Package
                    </h3>
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="bg-slate-50 border border-slate-200/80 rounded-3xl p-6 shadow-sm">
                ...
                <ul className="space-y-3">
                  {[
                    'Direct sponsorship with top-tier multinational E&P operators',
                    'High rotation rosters (28/28 or 14/14 days) with fully paid travel',
                    'Full support for OPITO BOSIET, IWCF, and CompEx certifications',
                    'Comprehensive international medical & family insurance packages',
                    'Global deployment across North Sea, Europe, and Middle Eastern assets',
                  ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
              Explore open upstream, midstream, and downstream positions with verified international E&P sponsorships.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14">
            ...
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-6">
                Operational Duties & Key Focus Areas
              </h3>
            ...
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-6">
                Required Credentials & Competencies
              </h3>
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-3">
                  Technical Software & Operational Skills
                </h4>
                <div className="flex flex-wrap gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-4">
              Career Growth & International Energy Perks
            </h2>
            <p className="text-slate-500 text-sm sm:text-base">
              Working with global E&P operators provides unparalleled remuneration, rotation freedom, and world-class technical exposure.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {department.careerOpportunities.map((opp, idx) => (
              ...
              >
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-600 to-orange-500 text-white flex items-center justify-center mb-5 shadow-md">
      ...
      {/* =========================================================
          6. OTHER OIL & GAS DEPARTMENTS (NAVIGATOR)
      ========================================================= */}
