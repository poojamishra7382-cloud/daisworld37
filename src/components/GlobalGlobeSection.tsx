      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="glassmorphism bg-[#071938]/80 border border-white/10 rounded-3xl p-6 sm:p-7 shadow-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Direct European Placement</h3>
              ...
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/10">
                <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
                  ...
                  <div className="text-white/60 text-xs mt-0.5">Nurses & Staff Placed</div>
                </div>
                <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
                  <div className="text-2xl font-black text-cyan-400">98%</div>
                  <div className="text-white/60 text-xs mt-0.5">Visa Approval Rate</div>
                </div>
              </div>
            </div>

            {/* Quick Country Pathways list */}
            <div className="glassmorphism bg-[#071938]/60 border border-white/10 rounded-3xl p-5 space-y-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2.5 rounded-2xl text-left transition-all duration-300 ${
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-bold text-sm shadow-xl shadow-blue-600/30 hover:-translate-y-0.5 transition-all duration-300"
              >
              ...
              <Link
                to="/country"
                className="inline-flex items-center gap-2 px-5 py-3.5 rounded-2xl glassmorphism bg-white/10 hover:bg-white/20 text-white font-semibold text-sm border border-white/15 transition-all duration-300"
              >
          ...
          <div className="lg:col-span-7 h-[460px] sm:h-[520px] lg:h-[560px] relative rounded-3xl overflow-hidden glassmorphism bg-gradient-to-b from-[#071938]/60 to-[#020b20]/90 border border-cyan-500/20 shadow-2xl">
