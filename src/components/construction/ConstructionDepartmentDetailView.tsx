...
import { ConstructionDepartment, constructionDepartments } from '@/data/constructionDepartments';

interface Props {
  department: ConstructionDepartment;
}

export default function ConstructionDepartmentDetailView({ department }: Props) {
  const [selectedRoleIndex, setSelectedRoleIndex] = useState(0);

  const activeRole = department.roles[selectedRoleIndex] || department.roles[0];
  const otherDepartments = constructionDepartments.filter((d) => d.id !== department.id);
  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-semibold uppercase tracking-wider mb-4">
            ...
            Construction & Infrastructure Department
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-2xl sm:text-4xl font-black text-slate-900 leading-tight mb-5">
                European & Global Engineering Standards in{' '}
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-900 mb-1">
                      International Site Benefits & Relocation Package
                    </h3>
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="bg-slate-50 border border-slate-200/80 rounded-3xl p-6 shadow-sm">
                <h3 className="text-lg font-black text-slate-900 mb-4 flex items-center gap-2">
                  ...
                  Why Construction Talents Choose Dais World Endeavor
                </h3>

                <ul className="space-y-3">
                  {[
                    'Direct contracts with accredited European general contractors',
                    'Full site safety compliance (VCA/SCC, OSHA, Eurocodes)',
                    'Furnished accommodation & certified toolkits provided',
                    'Comprehensive flight booking, work permit & visa support',
                    'Accelerated European permanent residency (PR) pathways',
                  ].map((item) => (
                ...
                >
                  Apply for Construction Evaluation
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
              Explore open engineering and skilled trade profiles with verified international contractor sponsorships.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-4">
              Career Growth & Expat Construction Perks
            </h2>
            <p className="text-slate-500 text-sm sm:text-base">
              Working on European mega-infrastructure provides exceptional savings, international certifications, and global mobility.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {department.careerOpportunities.map((opp, idx) => (
              ...
              >
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-600 to-yellow-500 text-white flex items-center justify-center mb-5 shadow-md">
      ...
      {/* =========================================================
          6. OTHER CONSTRUCTION DEPARTMENTS (NAVIGATOR)
      ========================================================= */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center sm:text-left">
            ...
            <h3 className="text-2xl sm:text-3xl font-black text-slate-900">
              Other Construction Departments
            </h3>
          </div>
